...
class StrategySelector:
    ...
    def _needs_mcts(self, strategy: str, query: str, context: Optional[Dict] = None) -> bool:
        ...
        complexity_indicators = [
            "complex", "difficult", "challenging", "optimize", "best",
            "maximum", "minimum", "optimal", "efficient"
        ]
        ...
        if context and context.get("complexity", 0) > 100:
            return True
