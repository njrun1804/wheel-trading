...
async def main():
    ...
    import argparse
    parser = argparse.ArgumentParser(description='Unity Wheel Trading Bot - Unified System')
    parser.add_argument('-p', '--portfolio', type=float, default=100000, 
                       help='Portfolio value (default: 100000)')
    parser.add_argument('-s', '--symbol', type=str, default='U',
                       help='Stock symbol (default: U)')
    ...
    print(f"🚀 Initializing Enhanced Wheel System...")
    ...
    try:
        ...
        recommendation = await system.generate_enhanced_recommendation(symbol=args.symbol)
