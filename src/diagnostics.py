...
class SelfDiagnostics:
    ...
    def _check_type_consistency(self) -> None:
        ...
        try:
            ...
            self.results.append(
                DiagnosticResult(
                    check_name="type_consistency", level="OK", message="Type hints validated"
                )
            )
        except Exception as e:
            self.results.append(
    ...
    def _check_performance(self) -> None:
        ...
        try:
            ...
            wheel.find_optimal_put_strike(
                current_price=100.0, available_strikes=strikes, volatility=0.3, days_to_expiry=45
            )
    ...
    def _check_dependencies(self) -> None:
        ...
        if missing:
            ...
            self.results.append(
                DiagnosticResult(
                    check_name="dependencies", level="OK", message="All dependencies available"
                )
            )
    ...
    def report(self, format: Literal["text", "json"] = "text") -> str:
        ...
        if format == "json":
            ...
            for r in self.results:
                symbol = {"OK": "✓", "WARNING": "⚠", "ERROR": "✗", "CRITICAL": "‼"}[r.level]
