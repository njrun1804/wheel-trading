...
class EVRiskAnalyzer:
    ...
    def analyze_position(
        ...
        if position_type == "CSP":
            ...
            avg_gain_missed = (
                underlying_price * 1.05 - strike
            ) * 100  # Assume 5% avg rise
        ...
        if (
            risk_adjusted_ev > 0
            and expected_return > self.config.risk.min_expected_return
        ):
    ...
    def _calculate_assignment_probability(
        ...
        if is_call:
            ...
            z = (
                np.log(spot / strike) + (0.02 - 0.5 * volatility**2) * time_to_expiry
    ...
    def analyze_portfolio(self, positions: list[dict]) -> dict:
        ...
        return {
            ...
            "average_win_probability": np.mean(
                [a.win_probability for a in position_analyses]
            ),
