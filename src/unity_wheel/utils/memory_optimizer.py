...
class MemoryStats:
    ...
    def __str__(self) -> str:
        return (f"Memory: {self.process_mb:.1f}MB process "
...
class MemoryEfficientArray:
    ...
    def _recycle(self) -> None:
        ...
        if self._size > keep_size:
            ...
            logger.debug(
                "array_recycled",
                extra={"new_size": self._size, "max_size": self.max_size}
            )
...
class StreamingDataProcessor:
    ...
    def process_chunks(self, 
                      ...
                      accumulator_func: Optional[callable] = None) -> Generator[Any, None, None]:
...
def set_memory_thresholds(warning_mb: float, critical_mb: float) -> None:
    ...
    logger.info(
        ...
        extra={"warning_mb": warning_mb, "critical_mb": critical_mb}
    )