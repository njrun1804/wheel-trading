...
class ParameterEvolution:
    ...
    def update_parameter(
        self, name: str, new_value: float, reason: str, performance_delta: float = 0.0
    ) -> bool:
        """
    ...
    def get_evolution_report(self) -> dict[str, Any]:
        ...
        report = {"global_stats": self.global_performance, "parameters": {}}

        for name, param in self.parameters.items():
            report["parameters"][name] = {
                "current_value": param.current_value,
                "initial_value": param.initial_value,
                "change_pct": (param.current_value - param.initial_value)
                / param.initial_value
                * 100,
