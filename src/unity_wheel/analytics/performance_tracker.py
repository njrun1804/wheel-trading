...
class PerformanceTracker:
    ...
    def record_recommendation(self, recommendation: Dict) -> int:
        ...
        with sqlite3.connect(str(self.db_path)) as conn:
            ...
            """, (
                trade.timestamp, trade.action, trade.strike, trade.dte,
                trade.delta_target, trade.kelly_fraction, trade.confidence,
                trade.predicted_return, trade.market_regime, trade.warnings_count,
    ...
    def update_outcome(self, trade_id: int, actual_return: float, 
                      days_held: int, exit_reason: str):
        ...
        logger.info(f"Updated trade {trade_id} outcome", 
                   actual_return=actual_return, exit_reason=exit_reason)
