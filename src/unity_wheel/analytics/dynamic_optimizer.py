...
class DynamicOptimizer:
    ...
    def _calculate_dynamic_delta(self, state: MarketState) -> float:
        ...
        vol_adjustment = -0.15 * self._sigmoid(
            (state.volatility_percentile - 0.5) * 4
        )
        ...
        delta = base_delta + vol_adjustment + momentum_adjustment + iv_adjustment + earnings_adjustment
