    ...
    def update_event_calendar(self, events: List[Dict]) -> None:
        ...
        for event in events:
            ...
            if event_type in self.event_history:
                ...
                iv_expansion = 1.2 if event_type != EventType.EARNINGS else self.earnings_iv_expansion
                accuracy = 0.5
        ...
        logger.info(
            f"Updated event calendar",
            extra={'n_events': len(self.event_calendar)}
        )
