        ...
        if len(tom_returns) > self.min_samples and len(other_returns) > self.min_samples:
            ...
            if p_value < 0.05:
                ...
                pattern = SeasonalPattern(
                    ...
                    strength=1 - p_value,
                    effect_size=effect_size,
                    best_action='Consider positions around month boundaries' if effect_size > 0 else 'Avoid month boundaries',
        ...
        if len(mid_returns) > self.min_samples:
            ...
            if p_value < 0.05:
                ...
                pattern = SeasonalPattern(
                    ...
                    strength=1 - p_value,
                    effect_size=effect_size,
                    best_action='Mid-month typically favorable' if effect_size > 0 else 'Avoid mid-month',
        ...
        if len(year_end_returns) > self.min_samples * 2:
            ...
            if p_value < 0.05:
                ...
                pattern = SeasonalPattern(
                    ...
                    strength=1 - p_value,
                    effect_size=effect_size,
                    best_action='Tax loss selling creates volatility' if effect_size < 0 else 'Year-end rally opportunity',
        ...
        if len(q4_returns) > self.min_samples * 3:
            ...
            if p_value < 0.10:  # Lower threshold for industry pattern
                ...
                pattern = SeasonalPattern(
                    ...
                    strength=1 - p_value,
                    effect_size=effect_size,
                    best_action='Q4 typically strong for gaming stocks' if effect_size > 0 else 'Q4 shows weakness',
        ...
        if len(summer_returns) > self.min_samples * 3:
            ...
            if p_value < 0.10:
                ...
                pattern = SeasonalPattern(
                    ...
                    strength=1 - p_value,
                    effect_size=effect_size,
                    best_action='Summer typically weak for gaming' if effect_size < 0 else 'Summer strength unusual',
