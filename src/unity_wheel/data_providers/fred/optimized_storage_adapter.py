...
from .fred_models import FREDObservation
...
class FREDOptimizedStorageAdapter:
    ...
    def store_series_data(
        self, series_id: str, observations: list[FREDObservation]
    ) -> int:
        ...
        try:
            ...
            logger.info(
                ...
                extra={
                    ...
                    "date_range": f"{observations[0].date} to {observations[-1].date}"
                    if observations
                    else "N/A",
                },
            )
    ...
    def store_multiple_series(
        self, series_data: dict[str, list[FREDObservation]]
    ) -> dict[str, int]:
    ...
    def get_latest_features(self, symbol: str = "U") -> dict[str, Any] | None:
        ...
        try:
            ...
            if result:
                ...
                features = dict(zip(columns, result, strict=False))
