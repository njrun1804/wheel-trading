...
class DataProviderFactory:
    ...
    def register_provider_class(self, name: str, provider_class: Type[BaseDataProvider]) -> None:
        ...
        logger.info(
            "provider_class_registered",
            extra={"name": name, "class": provider_class.__name__}
        )
    ...
    def set_provider_config(self, name: str, config: Dict) -> None:
        ...
        logger.info(
            "provider_config_set",
            extra={"name": name, "config_keys": list(config.keys())}
        )
    ...
    def create_unified_provider(self, 
                               ...
                               fallback_chains: Optional[Dict[str, List[str]]] = None) -> UnifiedDataProvider:
    ...
    def _get_enabled_providers_from_config(self, config) -> List[str]:
        ...
        if hasattr(config, 'data_providers'):
            ...
            if hasattr(data_config, 'databento') and getattr(data_config.databento, 'enabled', False):
    ...
    def _detect_providers_from_environment(self) -> List[str]:
        ...
        logger.info(
            "providers_detected_from_environment",
