...
class BaseDataProvider(ABC):
    ...
    def __init__(self, name: str, priority: int = 100):
        ...
        logger.info(
            ...
            extra={"provider": name, "priority": priority}
        )
...
class UnifiedDataProvider:
    ...
    def register_provider(self, provider: BaseDataProvider) -> None:
        ...
        for source_type in provider.get_supported_sources():
            ...
            # Sort by priority
            self._source_mapping[source_type].sort(
    ...
    def set_fallback_chain(self, source_type: DataSourceType, provider_names: List[str]) -> None:
        ...
        logger.info(
            "fallback_chain_set",
            extra={"source_type": source_type.value, "chain": provider_names}
        )
    ...
    async def get_options_chain(self,
                               ...
                               strike_filter: Optional[Tuple[float, float]] = None) -> DataResponse:
    ...
    async def get_economic_indicator(self,
                                   indicator: str,
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "source_mapping": {
                source.value: providers 
                for source, providers in self._source_mapping.items()
            }
        }
...
def get_unified_provider() -> UnifiedDataProvider:
    ...
    if _unified_provider is None:
        ...
        _unified_provider.set_fallback_chain(
            DataSourceType.MARKET_DATA, 
            ["databento", "mock"]
        )
        _unified_provider.set_fallback_chain(
