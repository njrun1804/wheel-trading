...
class CachedDataProvider(SyncDataProvider):
    ...
    def get_current_price(self, symbol: str) -> float:
        ...
        return self._get_from_cache_or_fetch(
            key, 
            lambda: self.async_provider.get_current_price_sync(symbol)
        )
    ...
    def get_option_chain(
        ...
        return self._get_from_cache_or_fetch(
            key,
            lambda: self.async_provider.get_option_chain_sync(symbol, expiration)
        )
    ...
    def get_historical_data(
        ...
        return self._get_from_cache_or_fetch(
            key,
            lambda: self.async_provider.get_historical_data_sync(
    ...
    def get_positions(self) -> List[Position]:
        ...
        return self._get_from_cache_or_fetch(
            key,
            lambda: self.async_provider.get_positions_sync()
        )
