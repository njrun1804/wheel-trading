...
class HealthCheckMCP(FastMCP):
    ...
    def __init__(self, name: str, workspace_root: str | None = None):
        super().__init__(name)
        self.name = name
    ...
    def _write_health_status(self, status: dict[str, Any]):
        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(
                mode="w", dir=self._health_file.parent, delete=False
            ) as tmp:
    ...
    @classmethod
    def cleanup_stale_health_files(
        cls, workspace_root: str, max_age_seconds: int = 300
    ):
