...
class WorkspaceIsolation:
    ...
    def register_service(self, service_name: str, pid: int, port: int | None = None):
    ...
    def get_workspace_stats(self) -> dict:
        ...
        try:
            total_size = 0
            for dirpath, _dirnames, filenames in os.walk(self.runtime_dir):
...
class WorkspaceManager:
    ...
    def list_workspaces() -> list[dict]:
        ...
        search_paths = [
            ...
            Path(
                "/Users/mikeedwards/Library/Mobile Documents/com~apple~CloudDocs/pMike"
            ),
        ]
