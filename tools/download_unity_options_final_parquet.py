    ...
    def show_summary(self):
        ...
        if stats and stats[0] > 0:
            ...
            if stats[3] and stats[4]:
                ...
                logger.info(f"  Average volume: {stats[6]:.0f}" if stats[6] else "  Average volume: N/A")
            ...
            if stats[0] < 100:
                ...
                logger.info("This is expected if Unity doesn't have actively traded options every day")
            else:
