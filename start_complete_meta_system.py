...
async def run_integrated_meta_loop():
    ...
    print(
        "This monitors Claude Code, detects mistakes, and triggers evolution automatically."
    )
...
def show_system_status():
    ...
    try:
        ...
        if evolution_events:
            ...
            print("   ⏳ No recent evolution activity")
    ...
    try:
        ...
        if meta.should_evolve():
            ...
            if success:
                ...
                for _timestamp, event_type, details, _context in recent:
