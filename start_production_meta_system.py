...
from production_meta_improvement_system import initialize_production_system
...
class ProductionStarter:
    ...
    def _show_startup_summary(self):
        ...
        print(
            f"   Pattern cache: {stats['pattern_cache_stats']['cache_size']} patterns"
        )
        print(
            f"   Improvement rules: {stats['pattern_cache_stats']['improvement_rules']} rules"
        )
    ...
    if __name__ == "__main__":
        try:
            ...
            while True:
                ...
                print(
                    f"📊 Status: {stats['total_intercepts']} intercepts, "
