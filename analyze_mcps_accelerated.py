...
async def analyze_mcp_server(
    server_name: str, config: dict[str, Any], script_contents: dict[str, str]
) -> dict[str, Any]:
    ...
    patterns = {
        ...
        "network_calls": "requests" in content
        or "httpx" in content
    ...
    if server_name in ["filesystem", "github"]:
        ...
        analysis[
            "recommendation"
        ] = "High-value search - implement locally with hardware acceleration"
        ...
        analysis[
            "recommendation"
        ] = "Trading-specific - better as local accelerated module"
        analysis[
            "local_alternative"
        ] = "Direct Python AST analysis with GPU acceleration"
        ...
        analysis[
            "local_alternative"
        ] = "Native DuckDB Python API with connection pooling"
...
async def main():
    ...
    # Categorize results
    categories = {"no_value": [], "worth_fixing": [], "replicate_locally": []}
