...
async def demo_env_injection():
    ...
    with SecretInjector(service="schwab"):
        ...
        print(f"  WHEEL_AUTH__CLIENT_ID: {os.environ.get('WHEEL_AUTH__CLIENT_ID', 'Not set')[:8]}...")
...
async def main():
    ...
    if any(var in os.environ for var in [
        "WHEEL_AUTH__CLIENT_ID", "WHEEL_AUTH__CLIENT_SECRET",
        "DATABENTO_API_KEY", "FRED_API_KEY", "OFRED_API_KEY"
    ]):
