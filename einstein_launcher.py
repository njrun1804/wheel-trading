...
class EinsteinLauncher:
    ...
    async def _show_capabilities(self) -> None:
        ...
        print(f"   Search modalities: Text, Semantic, Structural, Analytical")
        print(f"   Hardware acceleration: M4 Pro (12 cores + Metal GPU)")
        print(f"   Accelerated tools: 10+ high-performance components")
    ...
    async def search(self, query: str, optimize_for: str = "balanced") -> Dict[str, Any]:
        ...
        print(f"   Found: {summary['total_results']} results across {summary['unique_files']} files")
...
async def main():
    ...
    parser.add_argument("command", nargs='?', choices=[
        "init", "search", "context", "benchmark", "interactive"
    ], default="interactive", help="Command to execute")
    parser.add_argument("--query", "-q", help="Search query")
    parser.add_argument("--optimize", choices=["speed", "balanced", "comprehensive"], 
