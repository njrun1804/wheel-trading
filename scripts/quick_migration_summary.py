...
def print_migration_summary():
    console.print(
        Panel.fit("🚀 Wheel Trading Database Migration Summary", style="bold green")
    )
    ...
    current.add_row(
        ...
        "79MB",
        "15 tables",
        "Operational cache (mostly empty)",
    )
    current.add_row(
        "data/wheel_trading_optimized.duckdb",
        "268KB",
    ...
    current.add_row(
        "data/wheel_trading_optimized.duckdb", "4.3MB", "10 tables", "Trading decisions"
    )
