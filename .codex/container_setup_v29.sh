...
optional_packages="requests aiohttp pandas scipy asyncio-mqtt scikit-learn hypothesis google-cloud-secret-manager google-cloud-storage"
...
# Generated by container_setup_v30.sh on $(date)
...
if [ -f .codex/.env ]; then
    ...
    echo "   Run: ./.codex/container_setup_v30.sh"
fi
EOF
