...
## 🎯 **IMMEDIATE CONTEXT**
You have full access to the Unity Wheel Trading Bot codebase. The source lives in `src/unity_wheel/` (123 Python files). Use this directory directly along with `data_pipeline/config/` and related folders.

## 🔥 **CRITICAL SUCCESS PATTERNS**

### ✅ **What Works for You:**
1. **File Access**: Work within `src/unity_wheel/` for all code changes
