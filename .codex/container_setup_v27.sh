...
essential_packages="python-dotenv requests pydantic pydantic-settings PyYAML pytest"
optional_packages="pandas scipy aiohttp asyncio-mqtt scikit-learn hypothesis"
...
# Generated by container_setup_v28.sh on $(date)
...
if [ -f .codex/.container_env ]; then
    ...
    echo "   Run: ./.codex/container_setup_v28.sh"
fi
EOF
