...
# Try other packages
for pkg in pandas scipy pydantic python-dateutil scikit-learn hypothesis pytest; do
...
# Generated by container_setup_v26.sh on $(date)
...
if [ -f .codex/.env ]; then
    ...
    echo "   Run: ./.codex/container_setup_v26.sh"
fi
EOF
