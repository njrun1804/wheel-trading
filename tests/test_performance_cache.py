...
class TestEnhancedOptionsCalculations:
    ...
    def test_implied_volatility_cache_performance(self):
        ...
        iv_result1 = implied_volatility_enhanced(
            option_price, 100, 105, 0.25, 0.05, "call"
        )
        
        # Second calculation (cache hit)
        iv_result2 = implied_volatility_enhanced(
            option_price, 100, 105, 0.25, 0.05, "call"
        )
...
class TestCacheDecoratorIntegration:
    ...
    def test_cached_decorator_with_custom_key_function(self):
        ...
        @cached(
            cache_name="test_decorator",
            ttl_seconds=60,
            key_func=lambda x, y: f"custom_{x}_{y}"
        )
...
class TestPerformanceBenchmarks:
    ...
    def test_options_calculation_performance_improvement(self):
        ...
        print(f"Performance improvement: {(avg_first_pass - avg_second_pass) / avg_first_pass * 100:.1f}%")
