...
class TestProviderImplementations:
    ...
    async def test_databento_provider_options_data(self):
        ...
        with patch('src.unity_wheel.data_providers.databento.client.DatabentoClient'), \
             patch('src.unity_wheel.data_providers.databento.integration.DatabentoIntegration') as mock_integration:
...
class TestGlobalProvider:
    ...
    async def test_convenience_functions(self):
        ...
        with patch('src.unity_wheel.data_providers.unified_provider.get_unified_provider') as mock_get_provider:
