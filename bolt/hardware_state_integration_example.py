...
from hardware_state import get_hardware_state, HardwareState, ResourceBudget
...
class UnifiedHardwareAwareExecutor:
    ...
    def __init__(self):
        ...
        self.resource_budget: Optional[ResourceBudget] = None
    ...
    async def execute_task(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if task_type == 'neural':
            ...
            budget = self.resource_budget or self.hw_state.get_resource_budget('general')
...
class UnifiedResourceManager:
    ...
    async def create_agent(self, agent_type: str, memory_mb: int = 1024) -> str:
        ...
        if not budget:
            raise RuntimeError(f"Cannot create {agent_type} agent: insufficient resources")
...
async def migration_example():
    ...
    try:
        ...
        huge_agent = await manager.create_agent('cache', memory_mb=20000)
