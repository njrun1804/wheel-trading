...
from jarvis2.core.orchestrator import CodeRequest, Jarvis2Config, Jarvis2Orchestrator
...
Examples:
  ...
  jarvis2 --stats  # Show system statistics
    ...
    parser.add_argument("query", nargs="?", help="Code generation query")
    ...
    try:
        ...
        if args.stats:
            ...
            print(
                f"Memory usage: {stats['memory_stats']['system_used_gb']:.1f}GB / {stats['memory_stats']['system_memory_gb']:.1f}GB"
            )
        ...
        if args.interactive or not args.query:
            ...
            while True:
                try:
                    ...
                    print(
                        f"🔧 Backend: {solution.metrics.get('backend_used', 'unknown')}"
                    )
