...
class HardwareAwareExecutor:
    ...
    def __init__(self):
        ...
        logger.info(f"Detected {hw_info['model'].get('chip', 'CPU')} with "
                   f"{self.p_cores}P+{self.e_cores}E cores, "
                   f"{self.gpu_cores} GPU cores")
    ...
    async def _monitor_resources(self):
        ...
        # Import and initialize the enhanced monitor
            ...
            while True:
                try:
                    ...
                    if cpu_avg > 90 or memory_percent > 85 or self.gpu_utilization > 90:
                        logger.warning(
                            f"High resource usage - CPU: {cpu_avg:.1f}%, "
